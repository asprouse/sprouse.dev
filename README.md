...
| Path               | What it is                                                                                                                                                                                                                                                 |
| ------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `andrew/`          | Everything that defines Andrew: `cv.yml` (structured CV), `profile.md` (narrative + framings), `qa/` (chatbot corpus), `leadership.md` (CV's "How I run things" section), `APPROACH.md` (chatbot methodology). See [`andrew/README.md`](andrew/README.md). |
...
Methodology lives in [`andrew/APPROACH.md`](andrew/APPROACH.md) (also rendered at [`/about-the-bot`](https://sprouse.dev/about-the-bot) on the live site). The short version:
...
4. Replace `andrew/qa/*.md` with your own Q&A entries — see [`andrew/APPROACH.md`](andrew/APPROACH.md) for the format. Empty answers are silently skipped, so you can stub headings as you go.
...
- **JSON Schema** ([Ajv](https://ajv.js.org) for validation, [`json-schema-to-typescript`](https://github.com/bcherny/json-schema-to-typescript) for type codegen) for `andrew/cv.yml`
...
- [andrew/README.md](./andrew/README.md) — what's in the andrew/ directory and who reads what
- [andrew/APPROACH.md](./andrew/APPROACH.md) — chatbot methodology

## License

[MIT](./LICENSE). The personal content (everything under `andrew/`, plus the portrait illustrations) describes me specifically — you obviously shouldn't ship that as-yours. The code is yours to fork.
